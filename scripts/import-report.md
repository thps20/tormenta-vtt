...
Efeito mecânico preenchido só quando o texto inteiro casa um padrão estrito ("aumenta o dano em +XdY", "+XdY de dano", "muda o dano para XdY"): 18 `damageDiceAdd`. Os demais ficam como só custo e estão listados por categoria no fim deste relatório.
...
550 aprimoramentos ficaram como só custo (`effect` ausente) porque o texto não casa nenhum padrão estrito. Não entram no total de TODO; o jogador pode completar o efeito na ficha (modo edição).

### alcance (21)

- `acalmar-animal#e1`: muda o alcance para médio.
...
- `compreensao#e1`: muda o alcance para curto.
...
- `curar-ferimentos#e3`: muda o alcance para curto.
...
- `salto-dimensional#e1`: muda o alcance para médio.
- `salto-dimensional#e4`: muda o alcance para longo.
- `tranca-arcana#e1`: muda o alcance para curto e a duração para instantânea. Em vez do normal, a magia abre portas, baús…

### alvo adicional (172)

- `abencoar-alimentos#e1`: aumenta o número de alvos em +1.
...
- `acalmar-animal#e3`: aumenta o número de alvos em +1.
...
- `alterar-tamanho#e1`: aumenta o número de alvos em +1.
...
- `amarras-etereas#e1`: aumenta o número de alvos em +1.
...
- `aviso#e4`: aumenta o número de alvos em +1.
...
- `comando#e2`: aumenta a quantidade de alvos em +1
...
- `condicao#e1`: aumenta o número de alvos em +1.
...
- `convocacao-instantanea#e3`: aumenta o número de alvos em +1.
...
- `cranio-voador#e2`: aumenta o número de alvos em +1.
...
- `imobilizar#e2`: aumenta o número de alvos em +1.
...
- `legiao#e1`: aumenta o número de alvos em +1.
...
- `ligacao-telepatica#e1`: aumenta o número de alvos em +1.
...
- `sussurros-insanos#e1`: aumenta o número de alvos em +1.
...
- `teletransporte#e1`: aumenta o número de alvos em +5.
...
- `tranquilidade#e2`: aumenta o número de alvos em +1.
...
- `armadura-arcana#e3`: muda a duração para 1 dia.
...
- `engenho-de-mana#e2`: muda a duração para 1 dia.
- `escudo-da-fe#e5`: muda a duração para 1 dia. Requer 2º círculo.
- `escuridao#e3`: muda a duração para 1 dia.
- `hipnotismo#e3`: muda a duração para sustentada.
...
- `luz#e2`: muda a duração para 1 dia.
...
- `pele-de-pedra#e2`: muda a duração para 1 dia.
- `pele-de-pedra#e5`: como acima, mas com duração permanente. Requer 5º círculo.
- `premonicao#e2`: muda a duração para 1 dia.
...
- `visao-mistica#e2`: muda a duração para 1 dia.
...
- `medicina#e1`: Aumenta a cura em +1d6
...
- `musica-melodia-curativa#e1`: Aumenta a Cura em +1d6
...
- `tempestade-divina#e6`: muda a área para cilindro com 90m de raio e 90m de altura.
