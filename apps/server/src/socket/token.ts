import { TokenCreateSchema, TokenDeleteSchema, TokenPatchSchema, type Token } from "@tormenta-vtt/shared";
 ...
 */
function broadcastToken(io: TypedServer, roomId: string, token: Token, event: "token:created" | "token:updated") {
